...
class SearchResultsViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    var restaurantRatingsArray = [UIImage(named: "1 star"),UIImage(named: "2 star"),UIImage(named: "1 star"),UIImage(named: "1 star"),UIImage(named: "1 star"),UIImage(named: "1 star")]
